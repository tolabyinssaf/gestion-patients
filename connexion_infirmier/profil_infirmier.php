...
// SÉCURITÉ : On vérifie si c'est un infirmier
...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['sauvegarder'])) {
    ...
    if (isset($_FILES['nouvelle_photo']) && $_FILES['nouvelle_photo']['error'] === UPLOAD_ERR_OK) {
        ...
        if (in_array(strtolower($fileExtension), $allowedExtensions)) {
            ...
            $photo_name = "infirmier_" . $id_user . "_" . time() . "." . $fileExtension;
...
<head>
    ...
    <title>Mon Profil | Infirmier</title>
    ...
    <style>
        ...
        .photo-edit-btn { position: absolute; bottom: 5px; right: 5px; background: var(--primary); color: white; width: 40px; height: 40px; border-radius: 12px; display: flex; align-items: center; justify-content: center; cursor: pointer; border: 4px solid white; box-shadow: 0 4px 10px rgba(0,0,0,0.15); transition: 0.3s; }
...
<header>
    ...
    <div style="background: var(--primary-soft); color: var(--primary); padding: 10px 20px; border-radius: 15px; font-weight: 800; font-size: 0.9rem;">
        <i class="fa-solid fa-user-nurse me-2"></i>ESPACE INFIRMIER
    </div>
</header>
       ...
       <aside class="sidebar">
        ...
        <a href="profil_infirmier.php" class="active"><i class="fa-solid fa-user"></i> Profil</a>
                    ...
                    <div class="row align-items-center mb-5">
                        <div class="col-lg-7">
                            ...
                            <div class="d-flex flex-wrap gap-3 align-items-center">
                                <span class="status-tag"><i class="fa-solid fa-hand-holding-heart"></i> Infirmier(e)</span>
                    ...
                    <div class="mt-5 p-4 rounded-4 bg-light border d-flex align-items-start gap-3">
                        ...
                        <div>
                            <p class="small text-secondary m-0">
                                <strong>Sécurité du compte :</strong> Vos informations professionnelles sont protégées. Pour toute modification majeure, veuillez contacter le service administratif de l'hôpital.
                            </p>
                        </div>
                    </div>
                </div>
