...
// SÉCURITÉ : On vérifie si c'est une secrétaire
...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['sauvegarder'])) {
    ...
    if (isset($_FILES['nouvelle_photo']) && $_FILES['nouvelle_photo']['error'] === UPLOAD_ERR_OK) {
        ...
        if (in_array(strtolower($fileExtension), $allowedExtensions)) {
            ...
            $photo_name = "secretaire_" . $id_user . "_" . time() . "." . $fileExtension;
...
<header>
    ...
    <div style="background: var(--primary-soft); color: var(--primary); padding: 10px 20px; border-radius: 15px; font-weight: 800; font-size: 0.9rem;">
        <i class="fa-solid fa-address-book me-2"></i>ESPACE SECRÉTARIAT
    </div>
</header>
    ...
    <aside class="sidebar">
        ...
        <a href="caisse.php"><i class="fa-solid fa-wallet"></i> Caisse & Factures</a>
         <a href="profil_secretaire.php" class="active"><i class="fa-solid fa-user"></i> Profil</a>
                    ...
                    <div class="row align-items-center mb-5">
                        <div class="col-lg-7">
                            ...
                            <div class="d-flex flex-wrap gap-3 align-items-center">
                                <span class="status-tag"><i class="fa-solid fa-user-tie"></i> Secrétaire</span>
                    ...
                    <div class="mt-5 p-4 rounded-4 bg-light border d-flex align-items-start gap-3">
                        ...
                        <div>
                            <p class="small text-secondary m-0">
                                <strong>Gestion du compte :</strong> Les données administratives (CIN, Matricule) sont fixes. Pour tout changement d'affectation, veuillez contacter le responsable RH.
                            </p>
                        </div>
                    </div>
                </div>
